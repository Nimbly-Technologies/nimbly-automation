...
public HomePage_StepDefinitions (UtlisManager utlisManager)	//creating a constructor to use utlis class methods
{
...
public void navigate_to_homepage_screen() throws InterruptedException {
	HomePage homepage = utlisManager.appPageobjectManager.gethomepage();
