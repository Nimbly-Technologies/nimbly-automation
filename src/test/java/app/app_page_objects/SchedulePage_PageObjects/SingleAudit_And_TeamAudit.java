...
//locators of schedule page    //android.widget.TextView[@text="Tap to start audit"]
	...
	By select_questionnaire_from_searchbox_results	= AppiumBy.xpath("//android.widget.TextView[@text='Tap to start audit']");
...
public void search_for_adhoc_single_audit_site_in_schedulepage(String Singleauditsitename) throws InterruptedException 
{
	Thread.sleep(3000);
